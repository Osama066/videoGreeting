...
const generateLipSyncVideo = async (videoUrl, audioUrl, options = {}) => {
  ...
  const payload = {
    ...
    enable_hd_restoration: options.enableHdRestoration !== false,
    restorer_type: options.restorerType || 'codeformer',
    fidelity: typeof options.fidelity === 'number' ? options.fidelity : 0.7,
